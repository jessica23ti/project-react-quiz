...
export default function Testimonial() {
  const testimoniClass =
    "flex flex-col items-center bg-gray-100 shadow p-6 rounded-lg h-full";

  return (
    
    <div className="bg-white py-10 text-center mt-0">
       <h2 className="mb-1 py-20 font-poppins-extrabold text-indigo-800 text-4xl sm:text-7xl text-center leading-tight">
       Testimoni {" "} 🚀
      </h2>
